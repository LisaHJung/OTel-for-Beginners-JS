...
With your environment set up and a chance to visualize traces generated by your app in Jaeger, you might be wondering: how does your app actually create these traces? That’s where `instrumentation` comes in.

# Episode 4 -  What is instrumentation? 
